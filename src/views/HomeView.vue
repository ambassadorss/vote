...
<div class="bg-[#FFFFFE] min-h-screen text-black pt-12 pb-16">
<section class="py-4 px-4 border-b no-scrollbar border-[#DBDBDB] bg-[#FAFAFA] space-x-4 flex overflow-x-auto">
<div class="flex-shrink-0 flex flex-col items-center cursor-pointer">
<div class="rounded-full p-0.5 flex flex-col space-y-1 bg-gray-200">
<img src="https://proxy.duckduckgo.com/iu/?u=https://i.imgur.com/7OXeSik.jpg" alt="profile image" class="object-cover rounded-full w-[65px] h-[65px] border-2 border-white" loading="lazy" draggable="false">
</div>
...
<img src="https://proxy.duckduckgo.com/iu/?u=https://i.imgur.com/Wt8z8Oz.jpg" alt="profile image" class="object-cover rounded-full w-[65px] h-[65px] border-2 border-white" loading="lazy" draggable="false">
</div>
...
<div class="flex-shrink-0 flex flex-col items-center cursor-pointer">
<div class="rounded-full p-0.5 flex flex-col space-y-1 from-purple-600 bg-gradient-to-bl via-red-600 to-yellow-500">
<img src="https://proxy.duckduckgo.com/iu/?u=https://i.imgur.com/ymPNhzP.jpg" alt="profile image" class="object-cover rounded-full w-[65px] h-[65px] border-2 border-white" loading="lazy" draggable="false">
</div>
<span class="text-sm text-black/75">
jane</span>
</div>
<div class="flex-shrink-0 flex flex-col items-center cursor-pointer">
<div class="rounded-full p-0.5 flex flex-col space-y-1 from-purple-600 bg-gradient-to-bl via-red-600 to-yellow-500">
<img src="https://proxy.duckduckgo.com/iu/?u=https://i.imgur.com/mDSO281.jpg" alt="profile image" class="object-cover rounded-full w-[65px] h-[65px] border-2 border-white" loading="lazy" draggable="false">
</div>
<span class="text-sm text-black/75">
joanna</span>
</div>
<div class="flex-shrink-0 flex flex-col items-center cursor-pointer">
<div class="rounded-full p-0.5 flex flex-col space-y-1 from-purple-600 bg-gradient-to-bl via-red-600 to-yellow-500">
<img src="https://proxy.duckduckgo.com/iu/?u=https://i.imgur.com/5YXGQUD.jpg" alt="profile image" class="object-cover rounded-full w-[65px] h-[65px] border-2 border-white" loading="lazy" draggable="false">
</div>
<span class="text-sm text-black/75">
michelle</span>
</div>
<div class="flex-shrink-0 flex flex-col items-center cursor-pointer">
<div class="rounded-full p-0.5 flex flex-col space-y-1 from-purple-600 bg-gradient-to-bl via-red-600 to-yellow-500">
<img src="https://proxy.duckduckgo.com/iu/?u=https://i.imgur.com/nfaUp9a.jpg" alt="profile image" class="object-cover rounded-full w-[65px] h-[65px] border-2 border-white" loading="lazy" draggable="false">
</div>
<span class="text-sm text-black/75">
barisgoktepe</span>
</div>
<div class="flex-shrink-0 flex flex-col items-center cursor-pointer">
<div class="rounded-full p-0.5 flex flex-col space-y-1 from-purple-600 bg-gradient-to-bl via-red-600 to-yellow-500">
<img src="https://proxy.duckduckgo.com/iu/?u=https://i.imgur.com/nkigHmz.jpg" alt="profile image" class="object-cover rounded-full w-[65px] h-[65px] border-2 border-white" loading="lazy" draggable="false">
</div>
<span class="text-sm text-black/75">
slendershout</span>
</div>
<div class="flex-shrink-0 flex flex-col items-center cursor-pointer">
<div class="rounded-full p-0.5 flex flex-col space-y-1 from-purple-600 bg-gradient-to-bl via-red-600 to-yellow-500">
<img src="https://proxy.duckduckgo.com/iu/?u=https://i.imgur.com/bvVMwCM.jpg" alt="profile image" class="object-cover rounded-full w-[65px] h-[65px] border-2 border-white" loading="lazy" draggable="false">
</div>
<span class="text-sm text-black/75">
berkfelix</span>
</div>
<div class="flex-shrink-0 flex flex-col items-center cursor-pointer">
<div class="rounded-full p-0.5 flex flex-col space-y-1 from-purple-600 bg-gradient-to-bl via-red-600 to-yellow-500">
<img src="https://proxy.duckduckgo.com/iu/?u=https://i.imgur.com/gqYl1Y5.jpg" alt="profile image" class="object-cover rounded-full w-[65px] h-[65px] border-2 border-white" loading="lazy" draggable="false">
</div>
<span class="text-sm text-black/75">
alaz02</span>
</div>
<div class="flex-shrink-0 flex flex-col items-center cursor-pointer">
<div class="rounded-full p-0.5 flex flex-col space-y-1 from-purple-600 bg-gradient-to-bl via-red-600 to-yellow-500">
<img src="https://proxy.duckduckgo.com/iu/?u=https://i.imgur.com/sYiKuPU.jpg" alt="profile image" class="object-cover rounded-full w-[65px] h-[65px] border-2 border-white" loading="lazy" draggable="false">
</div>
<span class="text-sm text-black/75">
bas950</span>
</div>
<div class="flex-shrink-0 flex flex-col items-center cursor-pointer">
<div class="rounded-full p-0.5 flex flex-col space-y-1 from-purple-600 bg-gradient-to-bl via-red-600 to-yellow-500">
<img src="https://proxy.duckduckgo.com/iu/?u=https://i.imgur.com/rb0ENuM.png" alt="profile image" class="object-cover rounded-full w-[65px] h-[65px] border-2 border-white" loading="lazy" draggable="false">
</div>
<span class="text-sm text-black/75">
cem</span>
</div>
...
<div class="flex-shrink-0 flex flex-col items-center cursor-pointer">
<div class="rounded-full p-0.5 flex flex-col space-y-1 bg-gray-200">
<img src="https://proxy.duckduckgo.com/iu/?u=https://i.imgur.com/7OXeSik.jpg" alt="profile image" class="object-cover rounded-full w-[40px] h-[40px] border-2 border-white" loading="lazy" draggable="false">
</div>
<!---->
</div>
...
<img src="https://proxy.duckduckgo.com/iu/?u=https://i.imgur.com/XIe1ewy.jpg" alt="post image" class="w-full aspect-square object-cover">
<div class="flex flex-col px-4 py-2">
<div class="flex items-center justify-between">
<div class="flex items-center space-x-3 [&amp;>
*]:cursor-pointer">
<button type="button" class="outline-none" animation="true" data-v-04cd45a5="">
<svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" data-v-04cd45a5="">
<path stroke-linecap="round" stroke-linejoin="round" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" data-v-04cd45a5="">
</path>
</svg>
</button>
<svg preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24" width="1.2em" height="1.2em" class="h-8 w-8">
<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m3 20l1.3-3.9A9 8 0 1 1 7.7 19L3 20m9-8v.01M8 12v.01m8-.01v.01">
</path>
</svg>
...
<nav class="flex fixed top-0 lg:w-[27.5%] mx-auto shadow-sm inset-x-0 items-center bg-white justify-between px-4 py-2 border-b border-[#DBDBDB]">
<a href="/camera" class="">
<svg preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24" width="1.2em" height="1.2em" class="text-xl">
...
<nav class="fixed lg:w-[27.5%] border-t shadow-sm border-[#DBDBDB] mx-auto items-center bg-white inset-x-0 gap-x-8 bottom-0 py-2 px-4 flex text-2xl justify-evenly">
<a href="/" class="router-link-active router-link-exact-active" aria-current="page">
...
<svg preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24" width="1.2em" height="1.2em">
<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.5 12.572L12 20l-7.5-7.428m0 0A5 5 0 1 1 12 6.006a5 5 0 1 1 7.5 6.572">
</path>
</svg>
</a>
<a href="/profile" class="">
<div class="flex-shrink-0 flex flex-col items-center cursor-pointer">
<div class="rounded-full p-0.5 flex flex-col space-y-1">
<img src="https://proxy.duckduckgo.com/iu/?u=https://i.imgur.com/7OXeSik.jpg" alt="profile image" class="object-cover rounded-full w-[30px] h-[30px]" loading="lazy" draggable="false">
</div>
<!---->
</div>
</a>
...
export default {
  ...
  methods: {
    saveIdToLocalStorage() {
      // Check if the 'id' prop is available and save it to local storage
      if (this.id) {
