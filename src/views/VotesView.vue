...
<body>
  ...
  <div class="flex items-center justify-center">
    <div class="container mx-auto max-w-xl border border-gray-300 p-8 bg-white h-screen"> <!-- White background color -->
      <div class="m-20">
      
      <p class="text-gray-700 text-center">{{ $t('Vote.VoteSec') }}</p>
      <h1 class="text-3xl font-bold mb-4 text-center">{{ $t('Vote.VoteUn') }}</h1>
    </div>
    <hr class="mx-[300px]">
    </div>
  </div>
...
<div class="w-full">
<nav class="flex fixed top-0 shadow-sm inset-x-0 items-center bg-white justify-between px-4 py-2 border-b border-[#DBDBDB] max-w-xl mx-auto">
...
<nav class="fixed border-t shadow-sm border-[#DBDBDB] items-center bg-white inset-x-0 gap-x-8 bottom-0 py-2 px-4 flex text-2xl max-w-xl mx-auto justify-evenly">
    ...
    <a href="#" class="">
        <svg preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24" width="1.2em" height="1.2em">
            <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.5 12.572L12 20l-7.5-7.428m0 0A5 5 0 1 1 12 6.006a5 5 0 1 1 7.5 6.572"></path>
        </svg>
    </a>
    <a href="#" class="">
        <div class="flex-shrink-0 flex flex-col items-center cursor-pointer">
            <div class="rounded-full p-0.5 flex flex-col space-y-1">
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/40/Sunflower_sky_backdrop.jpg/220px-Sunflower_sky_backdrop.jpg" alt="profile image" class="object-cover rounded-full w-[30px] h-[30px]" loading="lazy" draggable="false">
            </div>
        </div>
    </a>
</nav>
...
<style>
    /* Additional style to center the body */
    body {
      display: flex;
